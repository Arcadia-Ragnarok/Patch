...
[SKID.NJ_KUNAI] = {
	...
	[SKID.KO_SETSUDAN] = {
		...
		targetWaveFileName = "effect\\T_Au¡¾a.wav",
		targetEffectNum = 1,
	...
	[SKID.KO_BAKURETSU] = {
		...
		targetWaveFileName = "effect\\¨¡©ª¢¯¡Æ¡¤©¡.wav",
		targetEffectNum = 1,
	...
	[SKID.KO_HAPPOKUNAI] = {
		beginMotionType = ACTOR_STATE.ST_NINJASKILL2,
		waveFileName = "effect\\T_E¢¬¢¯A¢¬¢çA¡À¡¾a.wav",
		effectNum = 2,
	...
	[SKID.KG_KYOMU] = {
		targetWaveFileName = "effect\\t_¢¯¢®©øEAo©ö©¡Aa.wav",
		targetEffectNum = 1,
	...
	[SKID.KG_KAGEMUSYA] = {
		targetWaveFileName = "effect\\mon_¡¾Y¡Æ¡©¨¬O¡¾¡ì.wav",
		targetEffectNum = 1,
	...
	[SKID.OB_ZANGETSU] = {
		...
		targetWaveFileName = "effect\\t_¥ìu¥ìiCN¢¬¢Ò©öy.wav",
		targetEffectNum = 1,
